...
const Register = () => {
    ...
    const buttonCheckComplete = () => {
        if (data.fullname && data.email && data.password && data.nik && data.nomor_telepon) {
            if (passwordSame) {
                return false;
            } else {
                return true;
            ...
            <div className="grid place-items-center h-screen">
                <div className="card bg-base-100 max-w-lg w-full">
                    <div className="card-body p-[50px] flex flex-col gap-[20px]">
                        ...
                        <Label text={"Buat Akun Sekarang Healing Kemudian"} />
                        ...
                        <p className="text-[12px] md:text-[16px]">
                            Sudah Punya Akun? <Link href="/login" className="text-center underline underline-offset-1  text-[#868B90]">Login</Link>
                        </p>
                    </div>
                </div>
            </div>
