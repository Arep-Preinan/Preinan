            ...
            <div className="mx-auto container pt-[48px] pb-[48px] pr-[20px] pl-[20px] md:pr-[50px] lg:pl-[100px] lg:pr-[100px] md:pl-[50px] flex flex-col gap-[50px]">
                <div className="flex justify-center flex-col items-center gap-4">
                    ...
                    <p className="text-justify">
                        Preinan adalah sebuah website yang menawarkan platform
                        pencarian destinasi liburan di kawasan indah Wonosobo.
                        Didesain untuk mempromosikan pariwisata lokal dan
                        mendukung UMKM, Preinan memiliki fitur memudahkan
                        pembelian tiket masuk ke tempat wisata dan menyediakan
                        e-tiket dengan barcode untuk keamanan dan kenyamanan
                        pengunjung. Preinan juga menyediakan informasi lengkap
                        tentang lokasi, harga tiket masuk, hingga akomodasi di
                        sekitar tempat wisata di tiga kategori wisata menarik di
                        Wonosobo, yaitu danau, gunung, dan air terjun.
                    </p>
                    <p className="text-justify">
                        Dengan fitur-fiturnya yang lengkap dan mudah digunakan,
                        Preinan adalah solusi terbaik bagi mereka yang ingin
                        merencanakan liburan tak terlupakan di Wonosobo. Temukan
                        destinasi liburan impianmu di website Preinan dan
                        nikmati keindahan alam Wonosobo.
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-[48px]">
                        <div className="flex flex-col items-center lg:items-start gap-4">
                            ...
                            <p className="flex items-start text-justify  text-white max-w-[700px]">
                                ...
                                pariwisata lokal dan mendukung UMKM di Wonosobo
                                dengan memberikan pengalaman liburan yang tak
                            ...
                            <p className="text-justify  text-white">
                                3. Menjaga keamanan dan kenyamanan pengunjung
                                dengan menyediakan e-tiket yang dilengkapi
                                dengan barcode.
                            </p>
                            <p className="text-justify  text-white">
                                4. Menyediakan informasi lengkap tentang tempat
                                wisata, termasuk lokasi, harga tiket masuk, dan
                                informasi terkait akomodasi di sekitar area
                                wisata.
                            </p>{" "}
                            <p className="text-justify  text-white">
                                5. Menjaga kepercayaan dan kepuasan pengunjung
