        ...
        <div className="bg-[#fafafa]">
            <Navbar user={props.auth.user}>
                ...
                <div className="xl:pl-[100px] xl:pr-[100px] mx-auto container max-md:pr-[20px] max-md:pl-[20px] flex flex-col gap-[48px]">
                    ...
                    <div
                        className="grid grid-cols-1 max-lg:place-items-center xl:grid-cols-[auto_511px] gap-[24px] xl:gap-[64px]"
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-6">
                            {props.auth.user ? (
                                ...
                                <div className="card xl:w-[511px] grid place-items-center bg-base-100 border  p-6">
