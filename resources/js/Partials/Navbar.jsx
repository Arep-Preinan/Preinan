                ...
                <div className="container flex items-center justify-between">
                    ...
                    <div className="dropdown dropdown-end lg:hidden">
                        ...
                        {showComponent && (
                            <aside
                                id="default-sidebar"
                                class="fixed top-0 right-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 transform-none"
                                aria-label="Sidebar"
                            >
                                        ...
                                        <li>
                                            {props.user ? (
                                                <div className="dropdown dropdown-bottom w-52">
                                                    ...
                                                    <ul
                                                        tabIndex={0}
                                                        className="dropdown-content menu p-2 shadow bg-base-100 w-52 rounded-box right-0"
                                                    >
                                                        <li>
                                                            <a>Item 1</a>
                                                        </li>
